export const habilidadesPorClase = {
  ...
  'Brujo': ['Arcano', 'Engaño'],
  'Hechicero': ['Arcano', 'Intimidación'],
  'Explorador': ['Naturaleza', 'Supervivencia'],
  'Guerrero': ['Atletismo', 'Intimidación'],
  'Clerigo': ['Religión', 'Medicina'],
  'Paladin': ['Persuasión', 'Religión'],
  'Barbaro': ['Atletismo', 'Supervivencia'],
  'Monje': ['Acrobacias', 'Sigilo'],
  'Artifice': ['Arcano', 'Investigación'],
